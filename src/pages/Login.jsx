        ...
        <div className="bg-white dark:bg-dark-800 rounded-3xl shadow-2xl p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-gradient-to-r from-primary-600 to-secondary-600 text-white rounded-xl font-semibold hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
